...
('Self-Driving car accidentally runs over a pedestrian who turns out to be a wanted terrorist; feature is immediately rebranded as "Bounty Mode" and Tesla claims the reward money', (SELECT id FROM stocks WHERE symbol = 'TSLA'), 40.0),
('Tesla acquires Brizzers™ strictly to train its Auto-Park neural net on how to aggressively ram large objects into impossibly tight spaces', (SELECT id FROM stocks WHERE symbol = 'TSLA'), 65.0),
